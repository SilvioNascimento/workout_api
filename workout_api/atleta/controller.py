...
from workout_api.atleta.schemas import AtletaIn, AtletaOut, AtletaUpdate, AtletaSummary
...
@router.get(
    ...
    response_model=Page[AtletaSummary],
)
async def query(db_session: DatabaseDependency, params: Params = Depends()):
...
# Adicione paginação à sua aplicação FastAPI
